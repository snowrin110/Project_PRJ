<%-- 
    Document   : detail
    Created on : Nov 6, 2022, 2:39:32 PM
    Author     : rinsnow
--%>
        ...
        <div class="container-fluid p-0">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="" class="dropdown-item active">Course Detail</a>
                    ...
                    <p class="btn btn-primary py-2 px-4 d-none d-lg-block">${acc} ${studentID}</p>
                </div>
            </nav>
        </div>
        <!-- Navbar End -->
                        ...
                        <div class="owl-carousel related-carousel position-relative" style="padding: 0 30px;">
                            <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="">
                                ...
                                <div class="courses-text">
                                    <h4 class="text-center text-white px-3">Maths 1</h4>
                                    <div class="border-top w-100 mt-3">
                                        <div class="d-flex justify-content-between p-4">
                                            <span class="text-white"><i class="fa fa-user mr-2"></i>Jhon Doe</span>
                                            <input class="fa fa-user mr-2" type="submit" value="Detail">
                                        </div>
                                    </div>
                                </div>
                            </a>
                            <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="">
                                ...
                                <div class="courses-text">
                                    <h4 class="text-center text-white px-3">Maths 2</h4>
                                    <div class="border-top w-100 mt-3">
                                        <div class="d-flex justify-content-between p-4">
                                            <span class="text-white"><i class="fa fa-user mr-2"></i>Jhon Doe</span>
                                            <input class="fa fa-user mr-2" type="submit" value="Detail">
                            ...
                            <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="">
                                ...
                                <div class="courses-text">
                                    <h4 class="text-center text-white px-3">Maths 3</h4>
                                    <div class="border-top w-100 mt-3">
                                        <div class="d-flex justify-content-between p-4">
                                            <span class="text-white"><i class="fa fa-user mr-2"></i>Jhon Doe</span>
                                            <input class="fa fa-user mr-2" type="submit" value="Detail">
                    ...
                    <div class="col-lg-4 mt-5 mt-lg-0">
                        <div class="bg-primary mb-5 py-3">
                            ...
                            <form action="test" method="get">
                                <div class="py-3 px-4">
                                    <p class="btn btn-block btn-secondary py-3 px-5">Learning now</p>
                                </div>
                                <div class="py-3 px-4">
                                    <input type="hidden" name="courseID" value="5"/>
                                    <input type="hidden" name="acc" value="${acc}"/>
                                    <input type="hidden" name="studentID" value="${studentID}"/>
                                    <button class="btn btn-block btn-secondary py-3 px-5" type="submit">Test now</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <a href="" class="text-decoration-none h6 m-0">Maths</a>
                                    <span class="badge badge-primary badge-pill">150</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <a href="" class="text-decoration-none h6 m-0">Sciene</a>
                                    <span class="badge badge-primary badge-pill">131</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <a href="" class="text-decoration-none h6 m-0">Physic</a>
                                    <span class="badge badge-primary badge-pill">78</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <a href="" class="text-decoration-none h6 m-0">Literature</a>
